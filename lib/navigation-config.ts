  ...
  sideNavItems: [
    ...
    },
    {
      ...
      children: [
        ...
        { id: "syllabus", label: "教学大纲管理", href: "/admin/operations/syllabus", matchers: ["/admin/operations/syllabus"] },
        ...
        { id: "preparation", label: "备课中心", href: "/admin/operations/preparation", matchers: ["/admin/operations/preparation"] },
