  ...
  sideNavItems: [
    ...
    },
    {
      ...
      children: [
        ...
        { id: "syllabus", label: "课程与能力目标管理", href: "/admin/operations/syllabus", matchers: ["/admin/operations/syllabus"] },
        { id: "teaching-plans", label: "教学计划管理", href: "/admin/operations/teaching-plans", matchers: ["/admin/operations/teaching-plans"] },
        { id: "scheduling", label: "排课管理", href: "/admin/operations/scheduling", matchers: ["/admin/operations/scheduling"] },
