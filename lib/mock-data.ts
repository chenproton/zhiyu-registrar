...
export const faculty: Faculty[] = [
  { id: 'f1', employeeId: 'T2021001', name: '周建国', password: '123456', departmentId: 'd1', teachingQualifications: ['程序设计', '数据结构'], isEnterpriseMentor: false, status: '在职', roles: ['系统管理员', '教师'] },
  { id: 'f2', employeeId: 'T2021002', name: '吴晓敏', password: '123456', departmentId: 'd1', teachingQualifications: ['人工智能', '机器学习'], isEnterpriseMentor: false, status: '在职', roles: ['教学秘书', '教师'] },
  ...
  { id: 'f4', employeeId: 'T2021004', name: '李红梅', password: '123456', departmentId: 'd2', teachingQualifications: ['机械设计', 'CAD/CAM'], isEnterpriseMentor: false, status: '在职' },
  { id: 'f5', employeeId: 'T2021005', name: '张大伟', password: '123456', departmentId: 'd3', teachingQualifications: ['会计学', '财务管理'], isEnterpriseMentor: false, status: '在职' },
  { id: 'f6', employeeId: 'T2021006', name: '赵丽华', password: '123456', departmentId: 'd4', teachingQualifications: ['平面设计', 'UI设计'], isEnterpriseMentor: true, enterpriseInfo: { company: '字节跳动', position: '设计总监', years: 6, field: '视觉设计' }, agreements: [{ id: 'a3', name: '字节跳动-UI设计实践合作协议', company: '字节跳动', startDate: '2025-01-01', endDate: '2027-12-31', status: '有效' }], status: '在职' },
  { id: 'f7', employeeId: 'T2021007', name: '刘建国', password: '123456', departmentId: 'd5', teachingQualifications: ['汽车维修', '新能源汽车'], isEnterpriseMentor: true, enterpriseInfo: { company: '比亚迪', position: '技术专家', years: 12, field: '汽车工程' }, agreements: [{ id: 'a4', name: '比亚迪-新能源汽车技术合作协议', company: '比亚迪股份有限公司', startDate: '2024-06-01', endDate: '2026-05-31', status: '有效' }], status: '在职' },
  { id: 'f8', employeeId: 'T2021008', name: '陈秀英', password: '123456', departmentId: 'd3', teachingQualifications: ['市场营销', '电子商务'], isEnterpriseMentor: false, status: '在职' },
  { id: 'f9', employeeId: 'T2021009', name: '孙伟', password: '123456', departmentId: 'd2', teachingQualifications: ['数控技术', '3D打印'], isEnterpriseMentor: false, status: '在职' },
  { id: 'f10', employeeId: 'T2021010', name: '郑雅琴', password: '123456', departmentId: 'd1', teachingQualifications: ['前端开发', 'Web设计'], isEnterpriseMentor: false, status: '在职' },
]
